...
```{r warning=FALSE, message=FALSE}
fit_knnreg<-train(Weekly_Sales~.,method="knn",data=training_set,metric="RMSE",tuneGrid = data.frame(k = seq(13, 13, 2)))
summary(fit_knnreg)
print(fit_knnreg)
fit_knnreg$bestTune
```
